...
-- establish a link between Semigroup₃ and AddSemigroup₃?
-- even when renaming it to m_assoc₃, everything works! => positional mapping
...
-- to_additive does not automatically create AddMonoid₃.toAddZeroClass
-- since Monoid₃.toMulOneClass is auto-generated by extends
attribute [to_additive existing] Monoid₃.toMulOneClass

export Semigroup₃ (mul_assoc₃)
export AddSemigroup₃ (add_assoc₃)

-- some automatic replacement in name (inv -> neg)
whatsnew in
@[to_additive]
...
-- This is unimportant, just to showcase that you can construct
-- an instance of AddMonoid₄ without providing nsmul
...
-- This is only a partial solution, in order to
-- complete the story, you need to incorporate
-- the definition of zsmul into the definition of groups
